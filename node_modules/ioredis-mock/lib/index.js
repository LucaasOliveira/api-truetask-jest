...
var require_constants = __commonJS({
  "node_modules/semver/internal/constants.js"(exports2, module2) {
    ...
    9007199254740991, MAX_SAFE_COMPONENT_LENGTH = 16, RELEASE_TYPES = [
      "major",
      "premajor",
      "minor",
      "preminor",
        ...
        switch (release) {
          ...
          case "pre":
            ...
            if (identifier) {
              ...
              compareIdentifiers(this.prerelease[0], identifier) === 0 ? isNaN(this.prerelease[1]) && (this.prerelease = [identifier, base]) : this.prerelease = [identifier, base];
            }
            break;
          default:
...
var require_parse = __commonJS({
  "node_modules/semver/functions/parse.js"(exports2, module2) {
    var { MAX_LENGTH } = require_constants(), SemVer = require_semver(), parse = (version, options) => {
      if (version instanceof SemVer)
        return version;
      if (typeof version != "string" || version.length > MAX_LENGTH)
        return null;
      try {
...
var require_diff = __commonJS({
  "node_modules/semver/functions/diff.js"(exports2, module2) {
    var parse = require_parse(), eq = require_eq(), diff = (version1, version2) => {
      let v1 = parse(version1), v2 = parse(version2);
      if (eq(v1, v2))
        return null;
      {
        let hasPre = v1.prerelease.length || v2.prerelease.length, prefix = hasPre ? "pre" : "", defaultResult = hasPre ? "prerelease" : "";
